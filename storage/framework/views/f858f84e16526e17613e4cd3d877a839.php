    ...
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 420px;">
        <div class="modal-content" style="border: none; border-radius: 20px; box-shadow: 0 25px 60px rgba(0,0,0,0.15); overflow: hidden; backdrop-filter: blur(20px);">
            ...
            <div class="modal-body" style="padding: 30px; background: linear-gradient(145deg, #ffffff 0%, #f8f9fa 50%, #ffffff 100%);">
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" id="loginForm" data-otp-enabled="false">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3 d-flex justify-content-between align-items-center">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a class="text-decoration-none" href="<?php echo e(route('password.request')); ?>" style="color: var(--primary-color, #0f5057); font-size: 0.85rem; font-weight: 600; transition: all 0.3s ease;" onmouseover="this.style.color='#0a3d42'; this.style.textDecoration='underline';" onmouseout="this.style.color='var(--primary-color, #0f5057)'; this.style.textDecoration='none';">
...
<?php /**PATH C:\xampp\htdocs\bytte.no\resources\views/components/login-modal.blade.php ENDPATH**/ ?>