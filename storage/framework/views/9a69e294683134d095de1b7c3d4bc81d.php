    ...
    <div class="seller-header">
        <div class="seller-welcome">
            ...
            <div class="seller-info">
                <h1 class="seller-name">Welcome back, <?php echo e(auth()->user()->name); ?></h1>
        ...
        <div class="seller-actions">
            ...
            <a href="<?php echo e(route('buyer.exchanges.index')); ?>" class="btn btn-outline-light btn-sm">
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($totalReceivedExchanges); ?></div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($pendingExchangesCount); ?></div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($completedExchangesCount); ?></div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($totalRentals); ?></div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <a href="<?php echo e(route('products.index')); ?>" class="btn btn-primary btn-lg w-100">
                                    <i class="fas fa-search d-block mb-1"></i>
                                    <span class="btn-text">Browse Products</span>
                                </a>
                            </div>
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <a href="<?php echo e(route('buyer.exchanges.index')); ?>" class="btn btn-secondary btn-lg w-100">
                                    <i class="fas fa-exchange-alt d-block mb-1"></i>
                                    <span class="btn-text">My Exchanges</span>
                                </a>
                            </div>
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <a href="<?php echo e(route('buyer.rentals.index')); ?>" class="btn btn-success btn-lg w-100">
                                    <i class="fas fa-calendar-alt d-block mb-1"></i>
                                    <span class="btn-text">My Rentals</span>
                                </a>
                            </div>
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <a href="<?php echo e(route('buyer.chats.admin')); ?>" class="btn btn-info btn-lg w-100 position-relative" id="chatActionBtn">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <a href="<?php echo e(route('buyer.account.edit')); ?>" class="btn btn-warning btn-lg w-100">
                                    <i class="fas fa-user-cog d-block mb-1"></i>
                                    <span class="btn-text">Account Settings</span>
                                </a>
                            </div>
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <a href="<?php echo e(route('buyer.exchanges.create')); ?>" class="btn btn-danger btn-lg w-100">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('buyer.exchanges.index')); ?>" class="btn btn-sm btn-outline-primary">View All</a>
                    </div>
                    <div class="card-body">
                        <?php if($recentReceivedExchanges->count() > 0): ?>
                            <div class="list-group list-group-flush">
                                <?php $__currentLoopData = $recentReceivedExchanges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exchange): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-center mb-2">
                                                    ...
                                                    <div>
                                                        <h6 class="mb-0"><?php echo e($exchange->proposer->name); ?></h6>
                                                        <small class="text-muted"><?php echo e($exchange->created_at->diffForHumans()); ?></small>
                                                    </div>
                                                </div>
                                                <div class="exchange-details">
                                                    <div class="mb-1">
                                                        ...
                                                        <strong><?php echo e(Str::limit($exchange->offeredProduct->title, 30)); ?></strong>
                                                    </div>
                                                    <div>
                                                        <i class="fas fa-arrow-left text-warning me-2"></i>
                                                        <small class="text-muted">For your:</small>
                                                        <strong><?php echo e(Str::limit($exchange->requestedProduct->title, 30)); ?></strong>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="d-flex flex-column align-items-end gap-2">
                                                <span class="badge bg-<?php echo e($exchange->status === 'pending' ? 'warning' : ($exchange->status === 'accepted' ? 'success' : 'secondary')); ?>">
                                                    <?php echo e(ucfirst($exchange->status)); ?>

                                                </span>
                                                <a href="<?php echo e(route('buyer.exchanges.show', $exchange)); ?>" class="btn btn-sm btn-outline-primary">
                        ...
                        <?php else: ?>
                            <div class="text-center py-5">
                                ...
                                <div class="d-flex gap-2 justify-content-center">
                                    ...
                                    <a href="<?php echo e(route('buyer.exchanges.create')); ?>" class="btn btn-outline-primary btn-sm">
            ...
            <div class="col-lg-6 mb-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('buyer.rentals.index')); ?>" class="btn btn-sm btn-outline-success">View All</a>
                    </div>
                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-center mb-2">
                                                    ...
                                                    <div>
                                                        <h6 class="mb-0"><?php echo e(Str::limit($rental->product->title, 35)); ?></h6>
                                                        <small class="text-muted">From <?php echo e($rental->product->user->name); ?></small>
                                                    </div>
                                                </div>
                                                <div class="rental-period">
                                                    <i class="fas fa-calendar-alt text-info me-2"></i>
                                                    <small><?php echo e($rental->start_date->format('M d')); ?> - <?php echo e($rental->end_date->format('M d, Y')); ?></small>
                                                </div>
                                            </div>
                                            <div class="d-flex flex-column align-items-end gap-2">
                                                <span class="badge bg-<?php echo e($rental->status === 'active' ? 'success' : ($rental->status === 'pending' ? 'warning' : 'secondary')); ?>">
                                                    <?php echo e(ucfirst($rental->status)); ?>

                                                </span>
                                                <a href="<?php echo e(route('buyer.rentals.show', $rental)); ?>" class="btn btn-sm btn-outline-success">
                        ...
                        <?php else: ?>
                            <div class="text-center py-5">
                                ...
                                <a href="<?php echo e(route('products.index')); ?>" class="btn btn-success btn-sm">
                                    <i class="fas fa-search me-1"></i>Browse Products
                                </a>
                            </div>
                        <?php endif; ?>
            ...
            <div class="stat-info">
                <div class="stat-value"><?php echo e($totalReceivedExchanges); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <div class="stat-value"><?php echo e($pendingExchangesCount); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <div class="stat-value"><?php echo e($completedExchangesCount); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <div class="stat-value"><?php echo e($totalRentals); ?></div>
        ...
        <div class="dashboard-card actions-card">
            ...
            <div class="card-body">
                <div class="quick-actions">
                    ...
                    <a href="<?php echo e(route('buyer.exchanges.index')); ?>" class="btn btn-secondary">
                        <i class="fas fa-exchange-alt me-2"></i>My Exchanges
                    </a>
                    <a href="<?php echo e(route('buyer.rentals.index')); ?>" class="btn btn-success">
                        <i class="fas fa-calendar-alt me-2"></i>My Rentals
                    </a>
                    <a href="<?php echo e(route('buyer.chats.admin')); ?>" class="btn btn-info" id="chatActionBtn">
                        <i class="fas fa-comments me-2"></i>Chat with Admin
                        <span class="chat-badge" id="chatBadge" style="display: none;">0</span>
                    </a>
                    <a href="<?php echo e(route('buyer.account.edit')); ?>" class="btn btn-warning">
                        <i class="fas fa-user-cog me-2"></i>Account Settings
                    </a>
                    <a href="<?php echo e(route('buyer.exchanges.create')); ?>" class="btn btn-danger">
            ...
            <div class="card-body">
                <?php if($recentReceivedExchanges->count() > 0): ?>
                    <div class="exchange-grid">
                        <?php $__currentLoopData = $recentReceivedExchanges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exchange): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="exchange-card" data-status="<?php echo e($exchange->status); ?>">
                                <div class="exchange-header">
                                    <div class="proposer-avatar">
                                        ...
                                        <div class="proposer-info">
                                            <span class="proposer-name"><?php echo e($exchange->proposer->name); ?></span>
                                            <span class="exchange-date"><?php echo e($exchange->created_at->diffForHumans()); ?></span>
                                        </div>
                                    </div>
                                    <span class="exchange-status <?php echo e($exchange->status); ?>">
                                ...
                                <div class="exchange-body">
                                    <div class="exchange-offer">
                                        <div class="product-info">
                                            ...
                                            <div>
                                                <small>Offers:</small>
                                                <strong><?php echo e(Str::limit($exchange->offeredProduct->title, 35)); ?></strong>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="exchange-request">
                                        <div class="product-info">
                                            ...
                                            <div>
                                                ...
                                                <strong><?php echo e(Str::limit($exchange->requestedProduct->title, 35)); ?></strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="exchange-actions">
                                    <?php if($exchange->status === 'pending'): ?>
                                        <a href="<?php echo e(route('buyer.exchanges.show', $exchange)); ?>" class="btn btn-sm btn-primary action-btn-primary">
                ...
                <?php else: ?>
                    <div class="empty-state enhanced">
                        ...
                        <div class="empty-actions">
                            ...
                            <a href="<?php echo e(route('buyer.exchanges.create')); ?>" class="btn btn-outline-primary btn-lg">
    ...
    <div class="requests-row">
        ...
        <div class="dashboard-card giveaway-card">
            <div class="card-header">
                ...
                <a href="<?php echo e(route('buyer.rentals.index')); ?>" class="btn btn-sm btn-outline-primary">View All</a>
            </div>
            <div class="card-body">
                <?php if($recentRentals->count() > 0): ?>
                            ...
                            <div class="giveaway-card">
                                <div class="giveaway-header">
                                    <div class="requester-info">
                                        <i class="fas fa-box"></i>
                                        <span><?php echo e(Str::limit($rental->product->title, 25)); ?></span>
                                    </div>
                                    <span class="giveaway-status <?php echo e($rental->status); ?>"><?php echo e(ucfirst($rental->status)); ?></span>
                                </div>
                                <div class="giveaway-body">
                                    <div class="giveaway-product">
                                        <small>From:</small>
                                        <strong><?php echo e($rental->product->user->name); ?></strong>
                                    </div>
                                ...
                                <div class="giveaway-actions">
                                    <a href="<?php echo e(route('buyer.rentals.show', $rental)); ?>" class="btn btn-sm btn-outline-primary">
                                        View Details
                                    </a>
                                </div>
                            </div>
...
<script>
    ...
    function updateChatUnreadCount() {
        fetch('<?php echo e(route('buyer.chats.unread-count')); ?>')
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bytte.no\resources\views/buyer/dashboard.blade.php ENDPATH**/ ?>