<?php $__env->startSection('title', config('settings.site_name', 'Bytte.no') . ' - ' . __('Exchange & Trade Platform')); ?>

<?php $__env->startSection('head'); ?>
    <!-- Enhanced Home Page Meta Tags -->
    <meta name="description" content="Discover amazing products for sale, exchange, and rent on <?php echo e(config('settings.site_name', 'Bytte.no')); ?>. Buy, sell, trade, and rent items in your local community.">
    <meta name="keywords" content="buy, sell, exchange, trade, rent, local marketplace, <?php echo e(config('settings.site_name', 'Bytte.no')); ?>, products, items, community">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo e(url()->current()); ?>">
    <meta property="og:title" content="<?php echo e(config('settings.site_name', 'Bytte.no')); ?> - Exchange & Trade Platform">
    <meta property="og:description" content="Discover amazing products for sale, exchange, and rent on <?php echo e(config('settings.site_name', 'Bytte.no')); ?>. Buy, sell, trade, and rent items in your local community.">
    <?php if($hero && $hero->background_image): ?>
        <meta property="og:image" content="<?php echo e(asset('storage/' . $hero->background_image)); ?>">
    ...
    <meta name="twitter:title" content="<?php echo e(config('settings.site_name', 'Bytte.no')); ?> - Exchange & Trade Platform">
    <meta name="twitter:description" content="Discover amazing products for sale, exchange, and rent on <?php echo e(config('settings.site_name', 'Bytte.no')); ?>. Buy, sell, trade, and rent items in your local community.">
    <?php if($hero && $hero->background_image): ?>
        <meta name="twitter:image" content="<?php echo e(asset('storage/' . $hero->background_image)); ?>">
    ...
    <script type="application/ld+json">
    {
        ...
        "sameAs": [
            "<?php echo e(config('settings.facebook_url')); ?>",
            "<?php echo e(config('settings.twitter_url')); ?>",
            "<?php echo e(config('settings.instagram_url')); ?>"
        ],
        "contactPoint": {
            "@type": "ContactPoint",
            "telephone": "<?php echo e(config('settings.phone')); ?>",
...
<div class="finn-main-container">
    ...
    <div class="category-bar">
        <div class="category-bar-items">
            <a href="<?php echo e(route('products.index')); ?>" class="category-bar-item <?php echo e(!request()->category ? 'active' : ''); ?>">
            ...
            <?php $__currentLoopData = $categories->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('categories.show', $category)); ?>"
                   class="category-bar-item <?php echo e(request()->route('category') == $category->id ? 'active' : ''); ?>">
    ...
    <div class="finn-layout">
            ...
            <div class="sidebar-section">
                ...
                <ul class="category-list">
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(route('categories.show', $category)); ?>" class="category-link">
                                <span><?php echo e($category->name); ?></span>
                                <span class="category-count"><?php echo e($category->products_count ?? 0); ?></span>
                            </a>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
        ...
        <main class="finn-content">
            ...
            <?php if($upcomingHomeSales->count() > 0): ?>
            <section class="mb-5 upcoming-sales-section">
                <div class="section-header">
                    <div>
                        ...
                        <p class="section-count"><?php echo e($upcomingHomeSales->count()); ?> sales near you</p>
                    </div>
                    <a href="<?php echo e(route('home-sales.index')); ?>" class="btn-finn" style="font-size: 14px; padding: 8px 16px;">
                ...
                <div class="listings-grid upcoming-sales-grid" style="grid-template-columns: repeat(4, 1fr); gap: 20px;">
                    <?php $__currentLoopData = $upcomingHomeSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homeSale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('home-sales.show', $homeSale)); ?>" class="home-sale-card text-decoration-none">
                            <div class="home-sale-image-container">
                                <?php if($homeSale->images && count($homeSale->images) > 0): ?>
                                    <?php if(strpos($homeSale->images[0], 'http') === 0): ?>
                                        <img src="<?php echo e($homeSale->images[0]); ?>" alt="<?php echo e($homeSale->title); ?>" class="home-sale-image">
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('storage/' . $homeSale->images[0])); ?>" alt="<?php echo e($homeSale->title); ?>" class="home-sale-image">
                                    <?php endif; ?>
                                <?php else: ?>
                            ...
                            <div class="home-sale-content">
                                <h5 class="home-sale-title"><?php echo e(Str::limit($homeSale->title, 50)); ?></h5>
                                <div class="home-sale-date">
                                    <i class="fas fa-calendar"></i>
                                    <?php echo e($homeSale->sale_date_from->format('M d')); ?> - <?php echo e($homeSale->sale_date_to->format('M d, Y')); ?>

                                </div>
                                <p class="home-sale-location mt-2">
                                    <i class="fas fa-map-marker-alt"></i>
                                    <?php echo e($homeSale->location); ?><?php echo e($homeSale->city ? ', ' . $homeSale->city : ''); ?>
                    ...
                    <div class="home-sale-slider" id="upcomingSalesSlider">
                        <?php $__currentLoopData = $upcomingHomeSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homeSale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="home-sale-slide">
                                <a href="<?php echo e(route('home-sales.show', $homeSale)); ?>" class="home-sale-slider-card text-decoration-none">
                                    <div class="slider-image-container">
                                        <?php if($homeSale->images && count($homeSale->images) > 0): ?>
                                            <?php if(str_starts_with($homeSale->images[0], 'http')): ?>
                                                <img src="<?php echo e($homeSale->images[0]); ?>" alt="<?php echo e($homeSale->title); ?>" class="slider-image">
                                            <?php else: ?>
                                                <img src="<?php echo e(asset('storage/' . $homeSale->images[0])); ?>" alt="<?php echo e($homeSale->title); ?>" class="slider-image">
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <div class="d-flex align-items-center justify-content-center h-100" style="background: linear-gradient(135deg, var(--finn-blue), #004a80);">
                                                <i class="fas fa-home fa-3x text-white"></i>
                                    ...
                                    <div class="slider-content">
                                        <h5 class="slider-title"><?php echo e(Str::limit($homeSale->title, 40)); ?></h5>
                                        ...
                                        <?php if($homeSale->available_items): ?>
                                            <div class="slider-items">
                                                <i class="fas fa-box"></i> <?php echo e(Str::limit($homeSale->available_items, 50)); ?>
            ...
            <?php if($featuredHomeSales && $featuredHomeSales->count() > 0): ?>
            <section class="home-sale-slider-section featured-sales-section">
                ...
                <div class="home-sale-slider-container">
                    ...
                    <div class="home-sale-slider" id="featuredSlider">
                        <?php $__currentLoopData = $featuredHomeSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homeSale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="home-sale-slide">
                                <a href="<?php echo e(route('home-sales.show', $homeSale)); ?>" class="home-sale-slider-card text-decoration-none">
                                    <div class="slider-image-container">
                                        <?php if($homeSale->images && count($homeSale->images) > 0): ?>
            ...
            <section class="features-section">
                <div class="features-grid">
                    ...
                    <a href="<?php echo e(route('home-sales.index')); ?>" class="feature-item text-decoration-none">
            ...
            <section class="mb-5 featured-items-section">
                <div class="section-header">
                    <div>
                        ...
                        <p class="section-count"><?php echo e($featuredProducts->count()); ?> items available</p>
                    </div>
                    <a href="<?php echo e(route('products.index')); ?>" class="btn-finn" style="font-size: 14px; padding: 8px 16px;">
                        View All <i class="fas fa-arrow-right ms-1"></i>
                    </a>
                </div>
                ...
                <?php if($featuredProducts->count() > 0): ?>
                    <div class="listings-grid">
                        <?php $__currentLoopData = $featuredProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('products.show', $product)); ?>" class="product-card text-decoration-none">
                                <div class="product-image-container">
                                    <?php if($product->images && count($product->images) > 0): ?>
                                        <?php if(str_starts_with($product->images[0], 'http')): ?>
                                            <img src="<?php echo e($product->images[0]); ?>" alt="<?php echo e($product->title); ?>" class="product-image">
                                        <?php else: ?>
                                            <img src="<?php echo e(asset('storage/' . $product->images[0])); ?>" alt="<?php echo e($product->title); ?>" class="product-image">
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <div class="d-flex align-items-center justify-content-center h-100" style="background: linear-gradient(135deg, var(--finn-blue), #004a80);">
                                    ...
                                    <?php if($product->listing_type == 'exchange'): ?>
                                        <span class="product-badge badge-exchange">Exchange</span>
                                    <?php elseif($product->listing_type == 'sale'): ?>
                                        <span class="product-badge badge-sale"><?php echo e(number_format($product->price, 0, ',', ' ')); ?> NOK</span>
                                ...
                                <div class="product-content">
                                    <?php if($product->listing_type == 'sale'): ?>
                                        <div class="product-price"><?php echo e(number_format($product->price, 0, ',', ' ')); ?> kr</div>
                                    <?php elseif($product->listing_type == 'giveaway'): ?>
                                    ...
                                    <h5 class="product-title"><?php echo e(Str::limit($product->title, 60)); ?></h5>
                                    ...
                                    <div class="product-meta">
                                        ...
                                        <span class="product-meta-item">
                                            <i class="fas fa-clock"></i> <?php echo e($product->created_at->diffForHumans()); ?>
                                    ...
                                    <div class="product-location">
                                        <span>
                                            <i class="fas fa-map-marker-alt"></i>
                                            <?php echo e($product->location ?? 'Norway'); ?>
            ...
            <div class="cta-section">
                ...
                <div style="display: flex; gap: 12px; justify-content: center; flex-wrap: wrap;">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>" class="btn-finn" style="background: transparent; color: white; border: 2px solid white;">
    ...
    <?php if($latestBlogs && $latestBlogs->count() > 0): ?>
    <div class="blog-fullwidth-section blog-fullwidth-section">
        <div class="section-header">
            <div>
                ...
                <p class="section-count"><?php echo e($latestBlogs->count()); ?> articles to read</p>
            </div>
            <a href="<?php echo e(route('blogs.index')); ?>" class="btn-finn" style="font-size: 14px; padding: 8px 16px;">
                View All <i class="fas fa-arrow-right ms-1"></i>
            </a>
        </div>
            ...
            <div class="blog-slider" id="blogSlider">
                <?php $__currentLoopData = $latestBlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="blog-slide">
                        <a href="<?php echo e(route('blogs.show', $blog)); ?>" class="blog-slider-card text-decoration-none">
                            <div class="blog-slider-image-container">
                                <?php if($blog->image): ?>
                                    <img src="<?php echo e(asset('storage/' . $blog->image)); ?>" alt="<?php echo e($blog->title); ?>" class="blog-slider-image">
                                <?php else: ?>
                            ...
                            <div class="blog-slider-content">
                                ...
                                <h5 class="blog-slider-title"><?php echo e(Str::limit($blog->title, 60)); ?></h5>
                                <p class="blog-slider-excerpt"><?php echo e(Str::limit(strip_tags($blog->content), 120)); ?></p>
                                <div class="blog-slider-meta">
                                    ...
                                    <?php if($blog->comments && $blog->comments->count() > 0): ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bytte.no\resources\views/index.blade.php ENDPATH**/ ?>