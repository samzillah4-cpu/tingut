                    ...
                    <div class="tab-pane fade show active" id="login-tab-pane" role="tabpanel" aria-labelledby="login-tab" tabindex="0">
                        <form method="POST" action="<?php echo e(route('login')); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="loginEmail" name="email" value="<?php echo e(old('email')); ?>" required style="border-radius: 12px; padding: 12px 16px; border: 2px solid #e5e7eb; transition: all 0.3s ease; font-size: 0.9rem;">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <a href="<?php echo e(route('password.request')); ?>" class="text-decoration-none small fw-medium" style="color: var(--primary-color); transition: color 0.3s ease;">
                                    Forgot password?
                                </a>
                            </div>
                    ...
                    <div class="tab-pane fade" id="signup-tab-pane" role="tabpanel" aria-labelledby="signup-tab" tabindex="0">
                        <form method="POST" action="<?php echo e(route('register')); ?>" id="signupForm" data-otp-enabled="true">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="signupName" name="name" value="<?php echo e(old('name')); ?>" required style="border-radius: 12px; padding: 12px 16px; border: 2px solid #e5e7eb; transition: all 0.3s ease; font-size: 0.9rem;">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="signupEmail" name="email" value="<?php echo e(old('email')); ?>" required style="border-radius: 12px; padding: 12px 16px; border: 2px solid #e5e7eb; transition: all 0.3s ease; font-size: 0.9rem;">
                                <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                            ...
                            <div class="mb-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label small fw-medium" for="terms" style="color: #6c757d; margin-left: 6px; line-height: 1.4;">
                                        I agree to the <a href="#" class="text-decoration-none fw-semibold" style="color: var(--primary-color);">Terms of Service</a> and <a href="<?php echo e(route('privacy-policy')); ?>" class="text-decoration-none fw-semibold" style="color: var(--primary-color);">Privacy Policy</a>
                                    </label>
                                </div>
...
</script><?php /**PATH C:\xampp\htdocs\bytte.no\resources\views/components/auth-modal.blade.php ENDPATH**/ ?>