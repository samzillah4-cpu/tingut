<?php $__env->startSection('title', config('settings.site_name', 'Bytte.no') . ' - Browse Categories'); ?>
                                ...
                                <div class="category-card-modern position-relative overflow-hidden" style="border-radius: 15px; background: white; box-shadow: 0 8px 25px rgba(0,0,0,0.1); transition: all 0.3s ease; height: 200px; border: 1px solid rgba(26, 105, 105, 0.1);">
                                    <?php if($category->image): ?>
                                        <?php if(str_starts_with($category->image, 'http')): ?>
                                            <img src="<?php echo e($category->image); ?>" alt="<?php echo e($category->name); ?>" class="w-100 h-100 object-fit-cover position-absolute top-0 start-0">
                                        <?php else: ?>
                                            <img src="<?php echo e(asset('storage/' . $category->image)); ?>" alt="<?php echo e($category->name); ?>" class="w-100 h-100 object-fit-cover position-absolute top-0 start-0">
                                        <?php endif; ?>
                                    <?php else: ?>
                                    ...
                                    <div class="category-overlay position-absolute top-0 start-0 w-100 h-100 d-flex align-items-end" style="background: linear-gradient(transparent, rgba(26, 105, 105, 0.9));">
                                        <div class="category-content p-4 text-white">
                                            <h5 class="category-title fw-bold mb-2"><?php echo e($category->name); ?></h5>
                                            <?php if($category->description): ?>
                                                <p class="category-description text-white-50 small mb-2" style="font-size: 0.8rem; line-height: 1.3;"><?php echo e(Str::limit($category->description, 80)); ?></p>
                                            <?php endif; ?>
                                            <div class="d-flex justify-content-between align-items-center">
                                                <span class="badge" style="background: #f8f0d4; color: var(--primary-color);"><?php echo e($category->products_count); ?> items</span>
            ...
            <?php else: ?>
                <div class="text-center py-5">
                    <div class="empty-state">
                        ...
                        <a href="<?php echo e(route('home')); ?>" class="btn btn-lg fw-bold" style="border-radius: 50px; background: linear-gradient(135deg, var(--primary-color) 0%, #1c6c6c 100%); color: white; border: none;">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bytte.no\resources\views/categories/index.blade.php ENDPATH**/ ?>