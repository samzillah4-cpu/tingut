<?php $__env->startSection('title', $homeSale->title . ' - Home Sale'); ?>
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>" class="text-decoration-none" style="color: var(--primary-color);">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><?php echo e($homeSale->title); ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                        ...
                        <div id="homeSaleCarousel" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <?php if($homeSale->images && count($homeSale->images) > 0): ?>
                                    <?php $__currentLoopData = $homeSale->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="carousel-item <?php echo e($index == 0 ? 'active' : ''); ?>">
                                            <?php if(str_starts_with($image, 'http')): ?>
                                                <img src="<?php echo e($image); ?>" class="d-block w-100" alt="<?php echo e($homeSale->title); ?>" style="height: 450px; object-fit: cover;">
                                            <?php else: ?>
                                                <img src="<?php echo e(asset('storage/' . $image)); ?>" class="d-block w-100" alt="<?php echo e($homeSale->title); ?>" style="height: 450px; object-fit: cover;">
                                            <?php endif; ?>
                                        </div>
                            ...
                            <?php if($homeSale->images && count($homeSale->images) > 1): ?>
                    ...
                    <div class="card mb-4 shadow-sm" style="border-radius: 15px; border: none;">
                        <div class="card-body p-4">
                            <h2 class="fw-bold mb-3" style="color: var(--primary-color);"><?php echo e($homeSale->title); ?></h2>
                    ...
                    <div class="card mb-4 shadow-sm" style="border-radius: 15px; border: none;">
                        <div class="card-body p-4">
                            <h4 class="fw-bold mb-4" style="color: var(--primary-color);">
                                <i class="fas fa-box-open mr-2"></i>Available Items (<?php echo e($homeSale->items->count()); ?>)
                            </h4>
                            <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="card h-100 home-sale-item-card" style="border-radius: 10px;">
                                            <div class="row no-gutters">
                                                <div class="col-4">
                                                    <?php if($item->image): ?>
                                                        <img src="<?php echo e(asset('storage/' . $item->image)); ?>" class="card-img" alt="<?php echo e($item->name); ?>" style="height: 120px; object-fit: cover; border-radius: 10px 0 0 10px;">
                                                    <?php else: ?>
                                                ...
                                                <div class="col-8">
                                                    <div class="card-body py-2 px-3">
                                                        <h6 class="card-title mb-1"><?php echo e($item->name); ?></h6>
                                                        <?php if($item->category): ?>
                                                            <span class="badge badge-light mb-1" style="font-size: 0.7rem;"><?php echo e($item->category); ?></span>
                                                        <?php endif; ?>
                                                        <?php if($item->condition): ?>
                                                            <span class="badge badge-outline-secondary mb-1" style="font-size: 0.7rem;"><?php echo e($item->condition); ?></span>
                                                        <?php endif; ?>
                                                        <?php if($item->description): ?>
                                                            <p class="card-text mb-1"><small class="text-muted"><?php echo e(Str::limit($item->description, 40)); ?></small></p>
                                                        <?php endif; ?>
                                                        <?php if($item->price): ?>
                                                            <p class="card-text fw-bold mb-0" style="color: var(--primary-color);"><?php echo e(number_format($item->price, 2, ',', '.')); ?> NOK</p>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="fw-bold"><?php echo e($homeSale->sale_date_from->format('M d, Y')); ?> - <?php echo e($homeSale->sale_date_to->format('M d, Y')); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        <span class="fw-bold d-block"><?php echo e($homeSale->location); ?></span>
                                        <?php if($homeSale->address): ?>
                                            <small class="text-muted"><?php echo e($homeSale->address); ?></small><br>
                                        <?php endif; ?>
                                        <?php if($homeSale->city): ?>
                                            <small class="text-muted"><?php echo e($homeSale->city); ?></small>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <span class="fw-bold d-block"><?php echo e($homeSale->user->name); ?></span>
                                        <small class="text-muted">Member since <?php echo e($homeSale->user->created_at->format('Y')); ?></small>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 15px; border: none; box-shadow: 0 10px 40px rgba(0,0,0,0.1); max-width: 500px;">
                ...
                <div class="modal-body" style="padding: 25px; background: #ffffff;">
                    <form id="contactForm">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="home_sale_id" value="<?php echo e($homeSale->id); ?>">
                        <input type="hidden" name="seller_id" value="<?php echo e($homeSale->user->id); ?>">
                        ...
                        <div style="background: #f8f9fa; border-radius: 10px; padding: 15px; margin-bottom: 20px; border: 1px solid #e9ecef;">
                            <div style="display: flex; align-items: center; gap: 12px;">
                                <div style="width: 35px; height: 35px; border-radius: 8px; background: linear-gradient(135deg, #0f5057, #1a6b6d); display: flex; align-items: center; justify-content: center; color: white; font-weight: 600; font-size: 0.9rem;">
                                    <?php echo e(substr($homeSale->user->name, 0, 1)); ?>

                                </div>
                                <div style="flex: 1;">
                                    <div style="font-weight: 600; color: #0f5057; font-size: 0.9rem;"><?php echo e($homeSale->user->name); ?></div>
                                    <div style="color: #6c757d; font-size: 0.8rem;">
                                        <i class="fas fa-map-marker-alt me-1"></i><?php echo e($homeSale->location); ?><?php echo e($homeSale->city ? ', ' . $homeSale->city : ''); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div style="position: relative;">
                                <input type="text"
                                       ...
                                       id="subject"
                                       name="subject"
                                       value="Inquiry about <?php echo e(Str::limit($homeSale->title, 25)); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <div style="position: relative;">
                                <textarea class="form-control"
                                          ...
                                          placeholder="Hi <?php echo e($homeSale->user->name); ?>, I'm interested in your home sale..."
                                          required>Hi <?php echo e($homeSale->user->name); ?>,

I'm interested in your home sale "<?php echo e($homeSale->title); ?>" in <?php echo e($homeSale->location); ?>. Could you please provide more details about the available items?
...
Thank you!</textarea>
    ...
    <script>
        ...
        function useTemplate(type) {
            ...
            const organizerName = '<?php echo e($homeSale->user->name); ?>';
            const saleTitle = '<?php echo e(Str::limit($homeSale->title, 20)); ?>';
            const location = '<?php echo e($homeSale->location); ?>';
...
Best regards.`;
        ...
        document.getElementById('contactForm').addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route("home-sales.contact")); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bytte.no\resources\views/home-sales/show.blade.php ENDPATH**/ ?>