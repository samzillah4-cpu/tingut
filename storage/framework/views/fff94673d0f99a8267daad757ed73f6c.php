<?php $__env->startSection('title', $category->name . ' - ' . config('settings.site_name', 'Bytte.no')); ?>
...
<div class="finn-main-container">
    ...
    <div class="section-header">
        <div>
            <?php if($category->is_real_estate): ?>
                <h1 class="section-title">🏠 <?php echo e($category->name); ?></h1>
                <p class="section-count"><?php echo e($products->total()); ?> properties found</p>
            <?php else: ?>
                <h1 class="section-title"><?php echo e($category->name); ?></h1>
                <p class="section-count"><?php echo e($products->total()); ?> products found</p>
            <?php endif; ?>
        </div>
        <a href="<?php echo e(route('categories.index')); ?>" class="btn-clear">
    ...
    <div class="filter-bar">
        <form action="<?php echo e(route('categories.show', $category)); ?>" method="GET" id="filterForm">
            <div class="filter-row">
                ...
                <div class="filter-group small">
                    ...
                    <input type="number" class="filter-input" name="min_price" placeholder="0" value="<?php echo e(request('min_price')); ?>">
                </div>

                <div class="filter-group small">
                    <label class="filter-label">Max Price (NOK)</label>
                    <input type="number" class="filter-input" name="max_price" placeholder="No limit" value="<?php echo e(request('max_price')); ?>">
                </div>

                <!-- Location -->
                <div class="filter-group">
                    <label class="filter-label">Location</label>
                    <input type="text" class="filter-input" name="location" placeholder="City or area" value="<?php echo e(request('location')); ?>">
                </div>
                ...
                <div class="filter-group small">
                    ...
                    <select class="filter-input" name="listing_type">
                        <option value="">All Types</option>
                        <option value="sale" <?php echo e(request('listing_type') == 'sale' ? 'selected' : ''); ?>>For Sale</option>
                        <option value="exchange" <?php echo e(request('listing_type') == 'exchange' ? 'selected' : ''); ?>>For Exchange</option>
                ...
                <div class="filter-group small">
                    ...
                    <select class="filter-input" name="sort">
                        <option value="latest" <?php echo e(request('sort', 'latest') == 'latest' ? 'selected' : ''); ?>>Newest First</option>
                ...
                <!-- Clear Button -->
                <div class="filter-group small" style="flex: 0 0 auto;">
                    <a href="<?php echo e(route('categories.show', $category)); ?>" class="btn-clear">
    ...
    <!-- Results Count -->
    <?php if(request()->hasAny(['property_type', 'min_price', 'max_price', 'min_bedrooms', 'location'])): ?>
        <p class="results-count">
            Showing <?php echo e($products->count()); ?> result(s)
            <?php if(request('property_type')): ?>
                for "<strong><?php echo e(ucfirst(request('property_type'))); ?></strong>"
            <?php endif; ?>
        </p>
    <?php endif; ?>
    ...
    <?php if($products->count() > 0): ?>
        <div class="listings-grid">
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('products.show', $product)); ?>" class="property-card">
                    <div class="property-image-container">
                        <?php if($product->images && count($product->images) > 0): ?>
                            <?php if(str_starts_with($product->images[0], 'http')): ?>
                                <img src="<?php echo e($product->images[0]); ?>" alt="<?php echo e($product->title); ?>" class="property-image">
                            <?php else: ?>
                                <img src="<?php echo e(asset('storage/' . $product->images[0])); ?>" alt="<?php echo e($product->title); ?>" class="property-image">
                            <?php endif; ?>
                        <?php else: ?>
                        ...
                        <div class="property-badges" style="position: absolute; top: 8px; left: 8px; right: 8px;">
                            ...
                            <?php elseif($product->is_giveaway || $product->listing_type == 'giveaway'): ?>
                    ...
                    <div class="property-content">
                        <h5 class="property-title"><?php echo e(Str::limit($product->title, 60)); ?></h5>

                        <?php if($product->is_for_sale && !$product->is_giveaway): ?>
                            <div class="property-price">
                                <i class="fas fa-tag"></i>
                                <?php echo e(number_format($product->sale_price, 0, ',', ' ')); ?> <?php echo e(config('settings.currency', 'NOK')); ?>
                        ...
                        <p class="property-description"><?php echo e(Str::limit($product->description, 100)); ?></p>
                            ...
                            <div class="property-details">
                                <?php if($product->house_rooms): ?>
                                    <div class="property-detail">
                                        ...
                                        <?php echo e($product->house_rooms); ?> rooms
                                    </div>
                                <?php endif; ?>
                                <?php if($product->house_bedrooms): ?>
                                    <div class="property-detail">
                                        <i class="fas fa-bed"></i>
                                        <?php echo e($product->house_bedrooms); ?> bed
                                    </div>
                                <?php endif; ?>
                                <?php if($product->house_bathrooms): ?>
                                    <div class="property-detail">
                                        <i class="fas fa-bath"></i>
                                        <?php echo e($product->house_bathrooms); ?> bath
                                    </div>
                                <?php endif; ?>
                                <?php if($product->house_living_area): ?>
                                    <div class="property-detail">
                                        <i class="fas fa-ruler-combined"></i>
                                        <?php echo e(number_format($product->house_living_area, 0, ',', ' ')); ?> m²
                                    </div>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
    ...
    <?php else: ?>
        <div class="empty-state">
            ...
            <?php endif; ?>
            <a href="<?php echo e(route('categories.show', $category)); ?>" class="btn-filter">
                <i class="fas fa-redo me-2"></i>View All <?php echo e($category->is_real_estate ? 'Properties' : 'Products'); ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bytte.no\resources\views/categories/show.blade.php ENDPATH**/ ?>