            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted"><?php echo e($sellers->total()); ?> total sellers</small>
                    </div>
                </div>
                <div class="d-flex align-items-center">
                    <!-- Bulk Actions -->
                    ...
                    <div class="btn-group me-3" role="group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.sellers.export', ['format' => 'pdf'])); ?>" target="_blank"><i class="fas fa-file-pdf text-danger me-2"></i>Export as PDF</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.sellers.export', ['format' => 'csv'])); ?>"><i class="fas fa-file-csv text-success me-2"></i>Export as CSV</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.sellers.export', ['format' => 'xlsx'])); ?>"><i class="fas fa-file-excel text-primary me-2"></i>Export as Excel</a></li>
                        </ul>
                    </div>

                    <a href="<?php echo e(route('admin.sellers.create')); ?>" class="btn px-3" style="border-radius: 8px; background-color: var(--primary-color); color: white; border-color: var(--primary-color);">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <div id="searchResults">
                    <?php echo $__env->make('admin.sellers.partials.table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </div>
        <div class="card-footer bg-light border-top-0">
            <div class="d-flex justify-content-between align-items-center">
                <div class="text-muted small">
                    Showing <?php echo e($sellers->firstItem() ?? 0); ?> to <?php echo e($sellers->lastItem() ?? 0); ?> of <?php echo e($sellers->total()); ?> sellers
                </div>
...
$(document).ready(function() {
    ...
    $('#bulkDeleteBtn').on('click', function() {
        ...
        if (confirm(`Are you sure you want to delete ${selectedIds.length} seller(s)? This action cannot be undone.`)) {
            ...
            const form = $('<form>', {
                'method': 'POST',
                'action': '<?php echo e(route("admin.sellers.bulk-delete")); ?>'
            });
    ...
    function performSearch(query) {
        $.ajax({
            url: '<?php echo e(route("admin.sellers.index")); ?>',
            method: 'GET',
            data: {
                search: query,
                ajax: 1
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bytte.no\resources\views/admin/sellers/index.blade.php ENDPATH**/ ?>