<?php $__env->startSection('title', 'Chat with ' . ($chat->user_id === auth()->id() ? ($chat->relatedUser ? $chat->relatedUser->name : 'Unknown') : ($chat->user ? $chat->user->name : 'Unknown'))); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="whatsapp-chat-container">
        ...
        <div class="whatsapp-header">
            <div class="whatsapp-welcome">
                <div class="whatsapp-avatar">
                    <i class="fas <?php echo e($chat->chat_type === 'customer_admin' ? 'fa-user-shield' : 'fa-store'); ?>"></i>
                </div>
                <div class="whatsapp-info">
                    <h5>Chat with <?php echo e($chat->user_id === auth()->id() ? ($chat->relatedUser ? $chat->relatedUser->name : 'Unknown') : ($chat->user ? $chat->user->name : 'Unknown')); ?></h5>
                    <small>
                        <?php if($chat->chat_type === 'customer_admin'): ?>
                            <i class="fas fa-shield-alt me-1"></i>Admin Support
                        <?php else: ?>
                            <i class="fas fa-store me-1"></i>Seller Chat
                        <?php endif; ?>
                        <?php if($chat->subject): ?>
            ...
            <div class="whatsapp-actions">
                <a href="<?php echo e(route('buyer.chats.index')); ?>" class="btn" title="Back">
                ...
                <?php $__currentLoopData = $chat->messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($currentDate !== $lastDate): ?>
                        ...
                        <div class="date-separator">
                            <span><?php echo e($message->created_at->isToday() ? 'Today' : ($message->created_at->isYesterday() ? 'Yesterday' : $message->created_at->format('M d, Y'))); ?></span>
                        </div>
                    <?php endif; ?>

                    <div class="message <?php echo e($bgClass); ?> <?php echo e($alignment); ?>" data-message-id="<?php echo e($message->id); ?>">
                        <div class="message-content">
                            <?php if(isset($message->message_type) && $message->message_type === 'file'): ?>
                                <div class="message-file">
                                    <i class="fas fa-file fa-lg"></i>
                                    <a href="<?php echo e(asset('storage/' . $message->message)); ?>" target="_blank" class="file-link">
                                        <?php echo e($message->file_name ?? 'Attachment'); ?>

                                    </a>
                                    <span class="file-size"><?php echo e($message->file_size ? round($message->file_size / 1024, 1) . ' KB' : ''); ?></span>
                                </div>
                            <?php else: ?>
                                <?php if(!$isOwnMessage): ?>
                                    <div class="message-sender"><?php echo e($senderName); ?></div>
                                <?php endif; ?>
                            ...
                            <div class="message-actions">
                                <button type="button" class="message-action-btn delete-message-btn" title="Delete" data-message-id="<?php echo e($message->id); ?>">
        ...
        <div class="whatsapp-input-area">
            <form action="<?php echo e(route('buyer.chats.store')); ?>" method="POST" class="d-flex align-items-center gap-2 w-100" id="chatForm" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
$(document).ready(function() {
    ...
    let lastMessageId = <?php echo e($chat->messages->max('id') ?? 0); ?>;
    ...
    $(document).on('click', '.delete-message-btn', function() {
        ...
        if (confirm('Are you sure you want to delete this message?')) {
            $.ajax({
                url: '/buyer/chats/' + chatId + '/messages/' + messageId,
                method: 'DELETE',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>'
                },
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bytte.no\resources\views/buyer/chats/show.blade.php ENDPATH**/ ?>