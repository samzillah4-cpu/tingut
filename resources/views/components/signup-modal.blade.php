                        ...
                        <div class="row g-3">
                            <div class="col-6">
                                <div class="form-check">
                                    <input class="form-check-input d-none" type="radio" name="role" id="roleCustomer" value="Customer" {{ old('role', 'Customer') == 'Customer' ? 'checked' : '' }} required>
                            ...
                            <div class="col-6">
                                <div class="form-check">
                                    <input class="form-check-input d-none" type="radio" name="role" id="roleSeller" value="Seller" {{ old('role') == 'Seller' ? 'checked' : '' }} required>
