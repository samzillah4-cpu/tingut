    ...
    <div class="d-flex align-items-start">
        ...
        <div class="flex-grow-1">
            ...
            <div class="d-flex gap-3">
                ...
                <a href="{{ route('privacy-policy') }}" class="text-decoration-none small fw-medium" style="color: var(--primary-color); transition: all 0.3s ease;">
        ...
        <div class="modal-content" style="border: none; border-radius: 16px; box-shadow: 0 20px 60px rgba(0,0,0,0.15); overflow: hidden;">
            <div class="modal-header" style="background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); color: white; border: none; padding: 24px;">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="modal-title fw-bold mb-0" id="gdprSettingsModalLabel">{{ __('gdpr.settings_title') }}</h5>
            ...
            <div class="modal-body p-0">
                <div class="p-4">
                    <p class="text-muted mb-4">{{ __('gdpr.settings_description') }}</p>
                </div>
                    ...
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="flex-grow-1 me-3">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <h6 class="mb-0 fw-bold" style="color: var(--primary-color);">{{ __('gdpr.essential_cookies') }}</h6>
                            </div>
                            <p class="mb-0 small text-muted">{{ __('gdpr.essential_description') }}</p>
                        </div>
                        <span class="badge" style="background: var(--primary-color); color: white; padding: 6px 12px; border-radius: 20px; font-size: 0.75rem; font-weight: 600;">{{ __('gdpr.always_active') }}</span>
                    </div>
                </div>
                    ...
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="flex-grow-1 me-3">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <h6 class="mb-0 fw-bold">{{ __('gdpr.analytics_cookies') }}</h6>
                            </div>
                            <p class="mb-0 small text-muted">{{ __('gdpr.analytics_description') }}</p>
                        </div>
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="analytics-cookies" style="width: 48px; height: 24px;">
                            <label class="form-check-label visually-hidden" for="analytics-cookies">{{ __('gdpr.analytics_cookies') }}</label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="flex-grow-1 me-3">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <h6 class="mb-0 fw-bold">{{ __('gdpr.functional_cookies') }}</h6>
                            </div>
                            <p class="mb-0 small text-muted">{{ __('gdpr.functional_description') }}</p>
                        </div>
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="functional-cookies" style="width: 48px; height: 24px;" checked>
                            <label class="form-check-label visually-hidden" for="functional-cookies">{{ __('gdpr.functional_cookies') }}</label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="flex-grow-1 me-3">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <h6 class="mb-0 fw-bold">{{ __('gdpr.marketing_cookies') }}</h6>
                            </div>
                            <p class="mb-0 small text-muted">{{ __('gdpr.marketing_description') }}</p>
                        </div>
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="marketing-cookies" style="width: 48px; height: 24px;">
                            <label class="form-check-label visually-hidden" for="marketing-cookies">{{ __('gdpr.marketing_cookies') }}</label>
                        </div>
                    </div>
                </div>
            </div>
