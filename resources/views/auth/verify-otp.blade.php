...
@section('title', 'Verify Your Email - ' . config('settings.site_name', 'Bytte.no'))
            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-4">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted mb-0">
                        We've sent a 6-digit code to <strong style="color: var(--primary-color); font-weight: 600;">{{ session('otp_email') }}</strong>
                    </p>
                </div>
                ...
                <div class="freecycle-card p-4">
                    <form method="POST" action="{{ route('otp.verify') }}" id="otpForm">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text"
                                   id="code"
                                   name="code"
                                   class="form-control form-control-lg text-center fw-bold {{ $errors->has('code') ? 'is-invalid' : '' }}"
                                   maxlength="6"
                                   pattern="[0-9]{6}"
                                   inputmode="numeric"
                                   placeholder="000000"
                    ...
                    <div class="text-center">
                        <div class="row g-2">
                            <div class="col-6">
                                <a href="{{ route('login') }}" onclick="clearOtpSession()" class="btn btn-sm btn-outline-secondary w-100">
                                    <i class="fas fa-arrow-left me-1"></i>Use Different Email
                                </a>
                            </div>
                            <div class="col-6">
                                <a href="{{ route('password.request') }}" class="btn btn-sm btn-outline-secondary w-100">
