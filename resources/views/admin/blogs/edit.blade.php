        ...
        <div class="card-header bg-white border-bottom-0 py-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <small class="text-muted">Update blog post details and content</small>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control form-control-lg border-0 bg-light" id="title" name="title" value="{{ old('title', $blog->title) }}" required style="border-radius: 8px; padding: 12px 16px;">
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control border-0 bg-light" id="content" name="content" required style="border-radius: 8px; padding: 12px 16px;">{{ old('content', $blog->content) }}</textarea>
                            @error('content')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="mb-4">
                            ...
                            @if($blog->image)
                                <div class="mt-3">
                                    <img src="{{ asset('storage/' . $blog->image) }}" alt="Current Image" class="img-fluid rounded" style="max-height: 200px; border-radius: 8px;">
                            ...
                            <div class="card border-0 bg-light" style="border-radius: 8px;">
                                <div class="card-body p-3">
                                    <div class="form-check mb-3">
                                        ...
                                        <small class="form-text text-muted d-block">Make this blog post visible to visitors</small>
                                    </div>

                                    <div class="mb-3">
                                        <label for="published_at" class="form-label fw-semibold">Publish Date & Time</label>
                                        <input type="datetime-local" class="form-control border-0 bg-white" id="published_at" name="published_at" value="{{ old('published_at', $blog->published_at ? $blog->published_at->format('Y-m-d\TH:i') : '') }}" style="border-radius: 6px;">
