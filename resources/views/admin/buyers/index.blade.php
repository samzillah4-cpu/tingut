            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted">{{ $buyers->total() }} total buyers</small>
                    </div>
                </div>
                <div class="d-flex align-items-center">
                    <!-- Bulk Actions -->
                    ...
                    <div class="btn-group me-3" role="group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('admin.buyers.export', ['format' => 'pdf']) }}" target="_blank"><i class="fas fa-file-pdf text-danger me-2"></i>Export as PDF</a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.buyers.export', ['format' => 'csv']) }}"><i class="fas fa-file-csv text-success me-2"></i>Export as CSV</a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.buyers.export', ['format' => 'xlsx']) }}"><i class="fas fa-file-excel text-primary me-2"></i>Export as Excel</a></li>
                        </ul>
                    </div>

                    <a href="{{ route('admin.buyers.create') }}" class="btn btn-sm px-3" style="border-radius: 8px; background-color: var(--primary-color); color: white; border-color: var(--primary-color);">
...
$(document).ready(function() {
    ...
    $('#bulkDeleteBtn').on('click', function() {
        ...
        if (confirm(`Are you sure you want to delete ${selectedIds.length} buyer(s)? This action cannot be undone.`)) {
            ...
            const form = $('<form>', {
                'method': 'POST',
                'action': '{{ route("admin.buyers.bulk-delete") }}'
            });
