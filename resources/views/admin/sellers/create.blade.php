            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white border-bottom-0 py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0">Create New Seller</h5>
                            <small class="text-muted">Add a new seller to the platform</small>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('admin.sellers.store') }}" method="POST">
                        ...
                        <div class="d-flex gap-2 mt-4 pt-3 border-top">
                            <button type="submit" class="btn px-4" style="border-radius: 8px; background-color: var(--primary-color); color: white; border-color: var(--primary-color);">
                                <i class="fas fa-user-plus me-2"></i>Create Seller
                            </button>
                            <a href="{{ route('admin.sellers.index') }}" class="btn btn-outline-secondary px-4" style="border-radius: 8px;">
