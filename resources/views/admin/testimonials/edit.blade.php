                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="customer_position" name="customer_position"
                                   value="{{ old('customer_position', $testimonial->customer_position) }}" placeholder="e.g., CEO, Marketing Manager">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="testimony" name="testimony" rows="6"
                                      placeholder="Enter the customer's testimonial..." required>{{ old('testimony', $testimonial->testimony) }}</textarea>
                            @error('testimony')
                                <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
