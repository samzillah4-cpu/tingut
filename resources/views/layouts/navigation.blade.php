<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        ...
                        @endphp
                        @if($logo)
                            <img src="{{ asset('storage/' . $logo) }}" alt="{{ config('settings.site_name', 'TingUt.no') }}" class="block h-9 w-auto" />
                        @else
                    ...
                    <div class="ml-3 hidden sm:block">
                        <p class="text-sm text-gray-600 font-medium">{{ $siteDescription }}</p>
                    </div>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('giveaways.index')" :active="request()->routeIs('giveaways.*')">
                        {{ __('Give Away') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('giveaways.index')" :active="request()->routeIs('giveaways.*')">
                {{ __('Give Away') }}
            </x-responsive-nav-link>
