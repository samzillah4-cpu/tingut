    ...
    <div class="seller-header">
        <div class="seller-welcome">
            ...
            <div class="seller-info">
                ...
                <p class="seller-subtitle">Manage your conversations with sellers and admins</p>
            </div>
        </div>
        <div class="seller-actions">
            <a href="{{ route('buyer.dashboard') }}" class="btn btn-outline-light btn-sm">
                <i class="fas fa-arrow-left me-1"></i>Back to Dashboard
            </a>
            <a href="{{ route('buyer.chats.admin') }}" class="btn btn-outline-light btn-sm">
...
@section('content')
    <div class="chats-container">
        <!-- Chat Type Tabs -->
        <div class="chat-tabs">
            <a href="{{ route('buyer.chats.index') }}?type=all" class="tab {{ !request('type') || request('type') == 'all' ? 'active' : '' }}">
                All Chats
            </a>
            <a href="{{ route('buyer.chats.index') }}?type=customer_seller" class="tab {{ request('type') == 'customer_seller' ? 'active' : '' }}">
                <i class="fas fa-store me-1"></i>Sellers
            </a>
            <a href="{{ route('buyer.chats.index') }}?type=customer_admin" class="tab {{ request('type') == 'customer_admin' ? 'active' : '' }}">
        ...
        <div class="chats-list">
            @if($chats->count() > 0)
                @foreach($chats as $chat)
                    @php
                        ...
                        $chatTypeLabel = $chat->chat_type === 'customer_seller' ? 'Seller' : 'Admin Support';
                        $isAdminChat = $chat->chat_type === 'customer_admin';
                    @endphp
                    <div class="chat-item {{ $unreadCount > 0 ? 'unread' : '' }}" onclick="window.location.href='{{ route('buyer.chats.show', $chat) }}'">
                        <div class="chat-avatar">
                            <i class="fas {{ $isAdminChat ? 'fa-user-shield' : 'fa-store' }}"></i>
                        </div>
                        <div class="chat-info">
            ...
            @else
                <div class="empty-state">
                    <i class="fas fa-comments"></i>
                    <h4>No chats yet</h4>
                    <p>Start a conversation with sellers or admins</p>
                    <a href="{{ route('buyer.chats.admin') }}" class="btn">
