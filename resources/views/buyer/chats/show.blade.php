    ...
    <div class="whatsapp-chat-container">
        ...
        <div class="whatsapp-header">
            ...
            <div class="whatsapp-actions">
                <a href="{{ route('buyer.chats.index') }}" class="btn" title="Back">
        ...
        <div class="whatsapp-input-area">
            <form action="{{ route('buyer.chats.store') }}" method="POST" class="d-flex align-items-center gap-2 w-100" id="chatForm" enctype="multipart/form-data">
                @csrf
